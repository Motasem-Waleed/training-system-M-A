export const WORKFLOW_STEPS = [
  ...
  {
    key: "sent_to_health_ministry",
    label: "مرسل لوزارة الصحة",
    order: 5,
    governingBody: "ministry_of_health",
  },
  {
    key: "health_ministry_approved",
    label: "موافقة وزارة الصحة",
    order: 6,
    governingBody: "ministry_of_health",
  },
  {
    key: "health_ministry_rejected",
    label: "مرفوض من وزارة الصحة",
    order: 6.1,
    governingBody: "ministry_of_health",
  },
