...
export default function EducationDirectorateTrainingRequests() {
  ...
  const fetchRequests = async () => {
    ...
    try {
      const res = await apiClient.get("/training-requests", {
        params: { book_status: "sent_to_directorate", governing_body: "directorate_of_education" }
      });
  ...
  return (
    <div className="container-fluid py-4">
      <h2>طلبات التدريب - مديرية التربية</h2>
